(function($) {
	...
	$(".generate-filter-year").children("input").on("click", function(){check_if_compulsory_filter_checked()});
	$(".generate-filter-paper").children("input").on("click", function(){check_if_compulsory_filter_checked()});
	$(".generate-filter-chapter").children("input").on("click", function(){check_if_compulsory_filter_checked()});
